...
public class FragmentFLMain extends HandleFragment<FragmentCpMainTopBinding>{
    ...
    public void initView() {
        ...
        subFrag = addSubFragment(R.id.list_frag, FragFLItemList.class, new AddSubFragListener<FragFLItemList>() {
            @Override
            public void onFindFromTag(FragFLItemList fragCpItemList) {
                subFrag = fragCpItemList;
                setupSubFrag();
            }

            @Override
            public void onNewInstance(FragFLItemList fragCpItemList) {
                subFrag = fragCpItemList;
            }
...
//        ZClient.getService(FSServer.class)
    ...
    private void initButtons() {
        ...
        topBinding.getRoot().findViewById(R.id.fcmt_more_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), OneFragActivity.class);
                intent.putExtra(OneFragActivity.EXTRA_KEY_FRAG_CLASS, FragChoseType.class);
                startActivity(intent);
            }
        });
    }
