...
public class FBFLListAdapter extends RecyclerViewAdapter<Football> {
    ...
    public FBFLListAdapter(Context context) {
    ...
    protected void convert(BaseViewHolder helper, Football item) {
        ...
        helper.setText(R.id.fl_item_people, ""+((int)(RandUtils.fixedRan.nextFloat() * 1000) + 500)+ "人已买");
        helper.setText(R.id.fl_item_now_price, item.getTime());
        helper.setText(R.id.fl_item_sub_price, "劵 ￥"+item.getCoupon()); //XXX 0
